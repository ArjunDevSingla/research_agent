...
def read_similarity_results(r, job_id) -> list[dict]:
...
def reconcile(job_id: str, r) -> None:
    ...
    graph = build_knowledge_graph(job_id, seed_title, similarity_results, gaps)
...
JOB_TIMEOUT = 600   # 10 minutes — give up waiting after this
